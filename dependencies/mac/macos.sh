...
###############################################################################
# Copied from the legendary `mathiasbynens/dotfiles`                          #
# https://mths.be/macos                                                       #
###############################################################################
...
# Here's how to reverse this process:
...
###############################################################################
# Copied from the venerable `maxgallo/dotfiles`                               #
# https://github.com/maxgallo/dotfiles/blob/master/macos.sh                   #
###############################################################################
